...
$\mathbf{D}^{asy-in}_{n,k}$ is called asymptotic-in mode field and far from the interaction region it corresponds to a wave incoming in channel $n$ and outgoing waves in every channel. % If we construct a superposition of asymptotic-in mode fields
